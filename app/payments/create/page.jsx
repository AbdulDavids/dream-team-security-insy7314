...
import CreatePaymentForm from './CreatePaymentForm.jsx'
import Link from 'next/link';

export default async function CreatePaymentPage(){
    // Get sesion from server-side cookies
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="flex justify-between items-center py-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                Secure SWIFT Payment Processing
                            </p>
                        </div>
                        <Link
                            href="/dashboard/user"
            ...
            <main className="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8">
                <CreatePaymentForm csrfToken={csrfToken} userName={user.userName} />
            </main>
        </div>
    );
}